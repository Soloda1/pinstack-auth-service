...
func (_m *TokenService) Login(ctx context.Context, login string, password string) (*model.TokenPair, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (*model.TokenPair, error)); ok {
		return rf(ctx, login, password)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) *model.TokenPair); ok {
...
func (_c *TokenService_Login_Call) Return(_a0 *model.TokenPair, _a1 error) *TokenService_Login_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *TokenService_Login_Call) RunAndReturn(run func(context.Context, string, string) (*model.TokenPair, error)) *TokenService_Login_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *TokenService) Refresh(ctx context.Context, refreshToken string) (*model.TokenPair, error) {
	ret := _m.Called(ctx, refreshToken)
	...
	var r0 *model.TokenPair
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*model.TokenPair, error)); ok {
		return rf(ctx, refreshToken)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *model.TokenPair); ok {
		r0 = rf(ctx, refreshToken)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*model.TokenPair)
...
func (_c *TokenService_Refresh_Call) Return(_a0 *model.TokenPair, _a1 error) *TokenService_Refresh_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *TokenService_Refresh_Call) RunAndReturn(run func(context.Context, string) (*model.TokenPair, error)) *TokenService_Refresh_Call {
	_c.Call.Return(run)
	return _c
}

// Register provides a mock function with given fields: ctx, user
func (_m *TokenService) Register(ctx context.Context, user *model.User) (*model.TokenPair, error) {
	...
	var r0 *model.TokenPair
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *model.User) (*model.TokenPair, error)); ok {
		return rf(ctx, user)
	}
...
func (_c *TokenService_Register_Call) Return(_a0 *model.TokenPair, _a1 error) *TokenService_Register_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *TokenService_Register_Call) RunAndReturn(run func(context.Context, *model.User) (*model.TokenPair, error)) *TokenService_Register_Call {
	_c.Call.Return(run)
	return _c
}
