...
func (_m *TokenService) Login(ctx context.Context, login string, password string) (*models.TokenPair, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (*models.TokenPair, error)); ok {
...
func (_c *TokenService_Login_Call) Return(_a0 *models.TokenPair, _a1 error) *TokenService_Login_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *TokenService_Login_Call) RunAndReturn(run func(context.Context, string, string) (*models.TokenPair, error)) *TokenService_Login_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *TokenService) Refresh(ctx context.Context, refreshToken string) (*models.TokenPair, error) {
	ret := _m.Called(ctx, refreshToken)
	...
	var r0 *models.TokenPair
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*models.TokenPair, error)); ok {
		return rf(ctx, refreshToken)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *models.TokenPair); ok {
		r0 = rf(ctx, refreshToken)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.TokenPair)
...
func (_c *TokenService_Refresh_Call) Return(_a0 *models.TokenPair, _a1 error) *TokenService_Refresh_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *TokenService_Refresh_Call) RunAndReturn(run func(context.Context, string) (*models.TokenPair, error)) *TokenService_Refresh_Call {
	_c.Call.Return(run)
	return _c
}

// Register provides a mock function with given fields: ctx, user
func (_m *TokenService) Register(ctx context.Context, user *models.User) (*models.TokenPair, error) {
	...
	var r0 *models.TokenPair
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *models.User) (*models.TokenPair, error)); ok {
		return rf(ctx, user)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *models.User) *models.TokenPair); ok {
		r0 = rf(ctx, user)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.TokenPair)
...
func (_c *TokenService_Register_Call) Run(run func(ctx context.Context, user *models.User)) *TokenService_Register_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *TokenService_Register_Call) Return(_a0 *models.TokenPair, _a1 error) *TokenService_Register_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *TokenService_Register_Call) RunAndReturn(run func(context.Context, *models.User) (*models.TokenPair, error)) *TokenService_Register_Call {
	_c.Call.Return(run)
	return _c
}
